...
export const rtdb      = getDatabase(app);    // Realtime Database — live overlay state, kill feed
export const firestore = getFirestore(app);   // Firestore — user profiles, subscriptions, promo codes
export const storage   = getStorage(app);     // Firebase Storage — team logos, sponsor images
