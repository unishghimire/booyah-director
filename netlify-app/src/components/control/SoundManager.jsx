      ...
      <div className="space-y-3">
        {SOUND_EVENTS.map(event => {
          ...
          return (
            <div
              key={event.key}
              className={`bg-slate-900/60 border rounded-xl p-4 transition-colors ${
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                {isPlaying ? (
                  <button
                    onClick={stopPreview}
                    className="px-2.5 py-1.5 rounded-lg bg-red-500/20 text-red-400 hover:bg-red-500/30 text-xs flex items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    disabled={!hasSound}
                    className="px-2.5 py-1.5 rounded-lg bg-slate-700 text-slate-300 hover:bg-slate-600 text-xs flex items-center gap-1 disabled:opacity-40 disabled:cursor-not-allowed"
                  >
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 bg-slate-950/60 border border-slate-800 rounded-lg px-3 py-2 text-xs text-slate-200 placeholder-slate-600 focus:border-purple-500/50 focus:outline-none"
                />
                ...
                {hasSound && (
                  <button
                    ...
                    className="px-2 py-2 rounded-lg bg-red-500/10 text-red-400 hover:bg-red-500/20"
                  >
