...
export default function TournamentSetup({ onCreated }) {
  ...
  const handlePlacementChange = (pos, val) => {
    setPlacements(prev => ({ ...prev, [pos]: Number(val) || 0 }));
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g. Booyah Championship 2026"
